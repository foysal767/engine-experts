                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <Link
                      ...
                      className="inline-flex items-center"
                    >
                      <h3 className='text-2xl text-white '>Engine Expert</h3>
                    </Link>
                  </div>
                  <div>
                    <button
                      ...
                      title="Close Menu"
                      className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-base-200 hover:text-black focus:bg-black focus:outline-none focus:shadow-outline"
                    ...
                    </li>
                    {
                      user?.uid ?
                        <div className='flex justify-center items-center'>
                          ...
                          <button
                            onClick={handleLogout}
                            className="font-medium tracking-wide mr-16 hover:bg-white hover:text-black px-2  rounded py-2  text-white transition-colors duration-200 "
                          >
                            Log Out
                          </button>
                        </div>
                        ...
                        <Link
                          to="/login"
                          className="font-medium tracking-wide text-yellow-400 transition-colors duration-200"
                        >
                          Log in
                        </Link>
                    }
