...
const PopularService = () => {
  return (
    <div className="font-poppins">
        <h2 className="text-5xl font-bold text-center my-14">Our Popular Services</h2>
      <div data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000" className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 place-items-center">
        ...
        <div className="card card-compact w-96 bg-gray-600 p-2 shadow-xl rounded-full py-12">
          ...
          <div className="card-body">
            <h2 className="text-xl font-bold text-center">Replace air filter</h2>
            <div className="mx-auto text-orange-500 flex">
            <AiFillStar></AiFillStar>
            <AiFillStar></AiFillStar>
            <AiFillStar></AiFillStar>
        ...
        <div className="card card-compact w-96 bg-gray-600 p-2 shadow-xl rounded-full py-12">
          <figure>
            <img className="w-3/4 rounded-none"
