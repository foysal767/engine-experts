...
// //                     <h1 class="text-3xl font-semibold ml-12 capitalize text-white">Log In To Engine Expert</h1>
  ...
  return (
    <div className="h-[800px] flex justify-center">
      <div className="w-96 p-7">
        ...
        <div className="divider">OR</div>
        <button onClick={googleSignIn} className="btn btn-outline w-full"><FcGoogle className="text-2xl mx-2"></FcGoogle> CONTINUE WITH GOOGLE</button>
      </div>
    </div>
  );
};
